...
<div class="col-md-4 col-md-push-2  col-xs-12 ">
	...
	<div style="font-size :20px; border-style: none  none none dotted; border-width: 3px; border-color: rgba(0, 0, 0, 0.1); height: 390px;text-align: justify;" class="col-md-4 col-md-push-2  col-xs-12 "><br>This the main system login form for to access the system. you can enter both Super and Basic admin login details. if you are not a memeber of systme create your login access with using <a target="_blank" style="font-colour="Blue"" href='superadmin.php'>Register Here</a>
<br>
